...
(function(global){
  ...
  const DICT = {
    ru: {
      ...
      "admin.shop_atlas":      "Атлас (PNG-спрайтлист)",
      "admin.shop_atlas_hint": "для нового украшения — обязателен; при правке — оставь пустым, чтобы не менять",
      ...
      "admin.shop_err_png":    "Файл должен быть PNG",
